...
cordova.define("cordova/plugins/barcodescanner", 
  function(require, exports, module) {
    ...
    BarcodeScanner.prototype.getLocation = function(successCallback, errorCallback) {
        if (errorCallback == null) { errorCallback = function() {}}
        ...
        exec(successCallback, errorCallback, 'BarcodeScanner', 'gps', []);
    };
    
    BarcodeScanner.prototype.showLoader = function(text) {
    	
    	exec(null, null, 'BarcodeScanner', 'show', [text]);
    };
    
    BarcodeScanner.prototype.hideLoader = function(text) {
    	
    	exec(null, null, 'BarcodeScanner', 'hide', []);
    };
